    ...
    houses: [
        {
            ...
            reviews: [
                ...
                {
                    reviewerName: "Ana",
                    content: "Muy acogedora y bien equipada, perfecta para unas vacaciones en familia.",
                    rating: 4,
                },
            ],
        },
        {
            ...
            reviews: [
                {
                    reviewerName: "Luis",
                    content: "Increíble estancia, todo muy limpio y en perfectas condiciones.",
                    rating: 5,
                },
                {
                    reviewerName: "Elena",
        ...
        },
        {
            ...
            reviews: [
                ...
                {
                    reviewerName: "Laura",
                    content: "Gran lugar para ir en grupo, tiene todo lo necesario para pasarla bien.",
                    rating: 5,
                },
            ],
        },
        {
            ...
            reviews: [
                {
                    reviewerName: "Isabel",
                    content: "Pequeño pero muy acogedor, perfecto para una escapada en pareja.",
                    rating: 4,
                },
                {
                    reviewerName: "Andrés",
